 ...
 */
class CRM_Custom_Upgrader_Base {
  ...
  static public function instance() {
    if (! self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Custom_Upgrader(
        'org.civicoop.dgw.custom',
        __DIR__ .'/../../../'
      );
    }
   ...
   *
   * @code
   * CRM_Custom_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
