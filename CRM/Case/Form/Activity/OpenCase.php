...
class CRM_Case_Form_Activity_OpenCase {
  ...
  static function endPostProcess(&$form, &$params) {
    ...
    CRM_Core_Error::debug('multi', $isMultiClient);
    CRM_Core_Error::debug('currentlyViewed', $form->_currentlyViewedContactId);
    CRM_Core_Error::debug('currentUserId', $form->_currentUserId);
