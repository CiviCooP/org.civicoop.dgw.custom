...
class CRM_Case_Form_Case extends CRM_Core_Form {
  ...
  public function postProcess() {
    ...
    /*
     * BOS1404941
     * E Hommel: toegevoegd omdat om mysterieuze redenen soms case_type_id niet meegenomen
     * wordt in params terwijl die wel in _submitValues staat?
     */    
    if (!isset($params['case_type_id']) && isset($this->_submitValues['case_type_id'])) {
        $params['case_type_id'] = $this->_submitValues['case_type_id'];
    }
