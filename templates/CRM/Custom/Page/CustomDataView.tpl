{*
 ...
 | Date         :   26 Jan 2011 (V3.3.0)                              |
 | Marker       :   DGW4                                              |
 | Description  :   Disable button Edit and Delete for tabs Huur-     |
 |                  overeenkomst and Koopovereenkomst                 |
 |                                                                    |
 | Date         :   28 Jan 2013                                       |
 | Marker       :   DGW34                                             |
 | Description  :   Disable button Edit and Delete for tabs Huur-     |
      ...
      {foreach from=$cd_edit.fields item=element key=field_id}
        ...
        <tr>
          ...
          {if $element.field_type == 'File'}
            ...
            <td class="html-adjust"><a href="#" onclick="imagePopUp('{$element.field_value.imageURL}'); return false;" ><img src="{$element.field_value.displayURL}" height = "100" width="100"></a></td>
              {else}
