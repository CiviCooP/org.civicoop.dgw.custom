{*
 ...
 | Marker       :   CoreCorp10  				      |
 | Description	:   Change var $title in Communicatievoorkeuren as    |
 |                  long as Word replacement does not work (3.4?)     |
 |                                                                    |
 | Author       :   Erik Hommel (erik.hommel@civicoop.org)            |
 | Date         :   2 April 2013                                      |
 | Marker       :   BOS1303566                                        |
 | Description  :   Greeting fields not available, set based on       |
 |                  prefix when creating or editing contact           |
 +--------------------------------------------------------------------+
*}
...
<div class="crm-accordion-wrapper crm-commPrefs-accordion collapsed">
 <div class="crm-accordion-header">
    {* CoreCorp10 translate $title to Communicatievoorkeuren *}
	{* {$title} *}
