{*
 ...
 | Date         :   31 Jan 2011 (V3.3.0)                              |
 | Marker       :   DGW5                                              |
 | Description  :   Can not delete address in CiviCRM (issue 144)     |
 | Date			:	17 Mar 2011 (V3.3.5)                              |
 | Marker		:	CoreCorp10									      |
 | Description	: 	Change var $title in Adres as long as Word        |
 |                  replacement does not work (until 3.4?)            |
 | Date			:	2 Jun 2011 (V3.3.6)                               |
 | Marker		:	DGW15    									      |
 | Description	: 	Open address tab as default                       |
 +--------------------------------------------------------------------+
*}
...
{* DGW15 Address tab default open *}
{* <div id="addressBlockId" class="crm-accordion-wrapper crm-address-accordion collapsed"> *}
<div id="addressBlockId" class="crm-accordion-wrapper crm-address-accordion open">
{* end DGW15 *}
 ...
 <div id="Address_Block_{$blockId}" {if $className eq 'CRM_Contact_Form_Contact'} class="boxBlock crm-edit-address-block crm-address_{$blockId}"{/if}>
  ...
  <table class="form-layout-compressed crm-edit-address-form">
   ...
   {if $className eq 'CRM_Contact_Form_Contact'}
     ...
     {* DGW5 *}
     {*{if $blockId gt 0} *}
     {if $blockId gt 0 and $contactType eq 'Organization'}
     {* End DGW5 *}
         <td>
