{*
 ...
 | Marker		:	CoreCorp10									      |
 | Description	: 	Change var $title in Demografie as long as Word   |
 |                  replacement does not work (until 3.4?)            |
 | Date			:	2 Jun 2011 (V3.3.6)                               |
 | Marker		:	DGW15   									      |
 | Description	: 	Demographics tab default open                     |
 +--------------------------------------------------------------------+
*}

{* DGW15 default demographics open *}
{*<div class="crm-accordion-wrapper crm-demographics-accordion collapsed">*}
<div class="crm-accordion-wrapper crm-demographics-accordion open">
{* end DGW15 *}
